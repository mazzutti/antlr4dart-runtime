...
abstract class ErrorListener {
  ...
  ///
  /// [recognizer] - What parser got the error. From this object, you can
  /// access the context as well as the input source.
  /// [offendingSymbol] - The offending token in the input token source,
  ...
  /// [charPositionInLine] - The character position within that line where
  /// the error occurred.
  /// [msg] - The message to emit.
  /// [e] - The exception generated by the parser that led to the reporting
  /// of an error. It is null in the case where the parser was able to recover
  /// in line without exiting the surrounding rule.
  ...
  /// [recognizer] is the parser instance.
  /// [dfa] is the DFA for the current decision.
  /// [startInde] the input index where the decision started.
