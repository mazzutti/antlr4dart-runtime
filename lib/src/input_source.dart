...
abstract class InputSource {
  ...
  ///
  /// The behavior of this method is unspecified if no call to an [InputSource]
  ...
  /// will be true:
  ///
  ///  * [index](InputSource.index) will give access to the index of the first
  ...
  /// an [InputSource] initializing method has occurred after this source
  /// was constructed.
  ///
...
class StringSource implements InputSource {
  ...
  /// about marked ranges, see [InputSource.mark].
  ///
